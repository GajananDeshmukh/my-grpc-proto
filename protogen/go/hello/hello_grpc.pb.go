...
const (
	...
	HelloService_SayManyHelloToEveryone_FullMethodName = "/hello.HelloService/SayManyHelloToEveryone"
)
...
type HelloServiceClient interface {
	...
	SayManyHelloToEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error)
}
...
func (c *helloServiceClient) SayManyHelloToEveryone(ctx context.Context, opts ...grpc.CallOption) (grpc.ClientStreamingClient[HelloRequest, HelloResponse], error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	stream, err := c.cc.NewStream(ctx, &HelloService_ServiceDesc.Streams[1], HelloService_SayManyHelloToEveryone_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &grpc.GenericClientStream[HelloRequest, HelloResponse]{ClientStream: stream}
...
// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayManyHelloToEveryoneClient = grpc.ClientStreamingClient[HelloRequest, HelloResponse]
...
type HelloServiceServer interface {
	...
	SayManyHelloToEveryone(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error
...
func (UnimplementedHelloServiceServer) SayManyHelloToEveryone(grpc.ClientStreamingServer[HelloRequest, HelloResponse]) error {
	return status.Errorf(codes.Unimplemented, "method SayManyHelloToEveryone not implemented")
}
...
func _HelloService_SayManyHelloToEveryone_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(HelloServiceServer).SayManyHelloToEveryone(&grpc.GenericServerStream[HelloRequest, HelloResponse]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type HelloService_SayManyHelloToEveryoneServer = grpc.ClientStreamingServer[HelloRequest, HelloResponse]
...
var HelloService_ServiceDesc = grpc.ServiceDesc{
	...
	Streams: []grpc.StreamDesc{
		...
		{
			StreamName:    "SayManyHelloToEveryone",
			Handler:       _HelloService_SayManyHelloToEveryone_Handler,
			ClientStreams: true,
		},
	},
