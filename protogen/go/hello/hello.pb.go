...
const file_proto_hello_hello_proto_rawDesc = "" +
	...
	"\x05greet\x18\x01 \x01(\tR\x05greet2\xd0\x01\n" +
	"\fHelloService\x127\n" +
	"\bSayHello\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x00\x12>\n" +
	"\rSayManyHellos\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x000\x01\x12G\n" +
	"\x16SayManyHelloToEveryone\x12\x13.hello.HelloRequest\x1a\x14.hello.HelloResponse\"\x00(\x01B<Z:github.com/GajananDeshmukh/my-grpc-proto/protogen/go/hellob\x06proto3"
...
var file_proto_hello_hello_proto_depIdxs = []int32{
	...
	0, // 2: hello.HelloService.SayManyHelloToEveryone:input_type -> hello.HelloRequest
	...
	1, // 5: hello.HelloService.SayManyHelloToEveryone:output_type -> hello.HelloResponse
